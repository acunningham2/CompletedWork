...
public class Billing {
	...
	public static final String configName = "Billing";
	public static final String customersProp = "Billing.customersFile";
	public static final String invoicesProp = "Billing.invoicesFile";
	...
	public Billing(com.amica.escm.configuration.api.Configuration configuration) {
		this(configuration.getString(customersProp), configuration.getString(invoicesProp));
	}

	public Billing() {
		this(ComponentConfigurationManager
				.getInstance()
